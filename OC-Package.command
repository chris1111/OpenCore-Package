...
pkgbuild --root ./OC-EFI --scripts ./ScriptEFI --identifier com.opencorePackage.OpenCorePackage.pkg --version 1.0 --install-location /tmp ./OpenCore-Package/BUILD-PACKAGE/opencorePackage.pkg
